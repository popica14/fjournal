...
export class MealComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.mealService
      ...
      .subscribe(
        (res: HttpResponse<IMeal[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInMeals(): void {
    this.eventSubscriber = this.eventManager.subscribe('mealListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMeal[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
